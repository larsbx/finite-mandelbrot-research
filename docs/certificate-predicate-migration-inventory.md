...
| Integer backend | `src/bigint_z.mojo` | dynamic limbs with exact ring/order/division/gcd and canonical integer serialization | ready for rational migration; consumers still block proof-grade acceptance |
