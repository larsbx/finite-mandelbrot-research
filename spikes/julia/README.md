...
This directory is for rapid Julia experiments concerning finite dynamical experiments, witness generation, and counterexample search under the repository's finite-only policy.
